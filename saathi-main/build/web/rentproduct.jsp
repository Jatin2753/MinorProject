...
<body>
    ...
    <div class="container">
        ...
        <div class="product-container">
            <%
                ResultSet rsp = food.DataUtility.executeDQL("SELECT * FROM product WHERE transaction_type='rent' OR transaction_type='buy,rent' ORDER BY product_name");
                while (rsp.next()) {
            %>
            <div class="product-card">
                <img src="images/<%= rsp.getString("img1") %>" alt="<%= rsp.getString("product_name") %>">
                <h4><%= rsp.getString("product_name") %></h4>
                <p>&#8377;<%= rsp.getString("rentprice") %> / day</p>
                <form action="cart.jsp?source=rent" method="post">
                    ...
                    <input type="hidden" name="rentprice" value="<%= rsp.getString("rentprice") %>">
