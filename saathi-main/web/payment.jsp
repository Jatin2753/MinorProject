...
<html>
    <head>
        <title>Food Point | Payment</title>
                                ...
                                <div>
                                    <div class="vertical_post check_box_agile">
                                        ...
                                        <div class="checkbox">								
                                            ...
                                            <label class="anim">
    <input type="checkbox" class="checkbox" style="width: 25px; height: 25px;">
    <span style="color: black; font-size: 18px;">Cash On Delivery</span> 
    <input type="checkbox" class="checkbox" style="width: 25px; height: 25px; margin-left: 50px;">
    <span style="color: black; font-size: 18px; margin-left: 80px;">Card Payment</span> 
</label>
